"""
Improved LangChain Runner for Groq + Enhanced Agents
"""
from copy import deepcopy
from typing import Dict, Any
from agents.blog_agents2 import enhanced_blog_chain, BlogState

def run_blog_chain(topic: str) -> BlogState:
    """Run enhanced blog generation chain using Groq"""
    initial_state = {
        "topic": topic,
...
def run_blog_with_custom_settings(
    ...
    """Run blog generation with custom settings using Groq"""
    initial_state = {
        "topic": topic,
